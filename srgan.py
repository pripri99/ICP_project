"""
Code from: https://github.com/eriklindernoren/Keras-GAN/blob/master/srgan/srgan.py
...
class SRGAN:
    def __init__(self):
        ...
        self.dataset_name = "all_HR_img"  # "img_align_celeba"
        self.data_loader = DataLoader(
            dataset_name=self.dataset_name, img_res=(self.hr_height, self.hr_width)
        )
    ...
    def build_generator(self):
        ...
        gen_hr = Conv2D(
            self.channels, kernel_size=9, strides=1, padding="same", activation="tanh"
        )(u2)
    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            if epoch % sample_interval == 0:
                ...
                # save models
                # model.save("my_model")
                self.discriminator.save("discriminator_srgan")
                self.generator.save("generator_srgan")
